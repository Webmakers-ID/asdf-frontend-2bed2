...
class UIUXDesignPage extends React.Component {
  render() {
          ...
          <div className={classes.container}>
            <GridContainer>
              <GridItem xs={12} sm={12} md={6}>
                <h1 className={classes.title}>Layanan UI/UX Design</h1>
                <h4>
                  Layanan UI/UX Design kami Lorem Ipsum Dolor sit amet. Lorem Ipsum Dolor sit amet. Lorem Ipsum Dolor sit amet.
                </h4>
                <br />
              </GridItem>
            </GridContainer>
        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div className={classes.container}>
            <div>
              ...
              <ProjectSection services={"UI/UX Design"} />
            </div>
          </div>
          <ServicesSection />
          <WorkSection />
...
export default withStyles(landingPageStyle)(UIUXDesignPage);
